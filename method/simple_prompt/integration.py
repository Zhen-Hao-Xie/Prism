...
def ensure_peft_extension_registered() -> None:
    ...
    from PEFT.peft.peft_model import PeftModelForCausalLMSimplePrompt
    from PEFT.peft.tuners.simple_prompt import SimplePromptConfig, SimplePromptModel
...
class Simple_promptIntegration(CLIntegration):
    ...
    def _find_simple_prompt_model(self, model) -> Optional[Any]:
        from PEFT.peft.tuners.simple_prompt import SimplePromptModel
    ...
    def _setup_simple_prompt_peft(self, model) -> None:
        ...
        from PEFT.peft.tuners.simple_prompt import SimplePromptConfig
