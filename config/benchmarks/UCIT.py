...
UCIT_TASKS = [
    ...
    },
    {
        "cur_task": 1,
        "name": "ArxivQA",
        "train_data_path": f"{UCIT_INSTRUCTION_DIR}/ArxivQA/train_4w_sub.json",
        "test_data_path": f"{UCIT_INSTRUCTION_DIR}/ArxivQA/test_3000_sub.json",
        "eval_annotation_path": f"{UCIT_INSTRUCTION_DIR}/ArxivQA/test_3000_sub.json",
    ...
    },
    {
        "cur_task": 2,
        "name": "Vizcap",
        "train_data_path": f"{UCIT_INSTRUCTION_DIR}/VizWiz/train_sub.json",
        "test_data_path": f"{UCIT_INSTRUCTION_DIR}/VizWiz/test_3000_sub.json",
        "eval_annotation_path": f"{UCIT_INSTRUCTION_DIR}/VizWiz/val_coco_type_3000_sub.json",
    ...
    },
    {
        "cur_task": 3,
        "name": "IconQA",
        "train_data_path": f"{UCIT_INSTRUCTION_DIR}/IconQA/train_sub.json",
        "test_data_path": f"{UCIT_INSTRUCTION_DIR}/IconQA/test_3000_sub.json",
        "eval_annotation_path": f"{UCIT_INSTRUCTION_DIR}/IconQA/test_3000_sub.json",
    ...
    },
    {
        "cur_task": 4,
        "name": "CLEVR",
        "train_data_path": f"{UCIT_INSTRUCTION_DIR}/CLEVR/train_4w_sub.json",
        "test_data_path": f"{UCIT_INSTRUCTION_DIR}/CLEVR/test_3000_sub.json",
        "eval_annotation_path": f"{UCIT_INSTRUCTION_DIR}/CLEVR/test_3000_sub.json",
    ...
    },
    {
        "cur_task": 5,
        "name": "Flickr30k",
        "train_data_path": f"{UCIT_INSTRUCTION_DIR}/Flickr30k/train_brief_4w_sub.json",
        "test_data_path": f"{UCIT_INSTRUCTION_DIR}/Flickr30k/test_3000_sub.json",
        "eval_annotation_path": f"{UCIT_INSTRUCTION_DIR}/Flickr30k/val_coco_type_sub.json",
