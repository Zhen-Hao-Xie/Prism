...
UCIT_TASKS = [
    ...
    },
    {
        ...
        "eval_annotation_path": f"{UCIT_INSTRUCTION_DIR}instructions/Flickr30k/val_coco_type_3000.json",
        "output_dir": f"{CHECKPOINT_DIR}/UCIT/Task6_llava_lora",
        "batch_size": 12,
        "previous_task": f"{CHECKPOINT_DIR}/UCIT/Task5_llava_lora",
        "image_folder": UCIT_IMAGE_DIR,
        "eval": {
            "inference_args": [],
            "eval_args": [
