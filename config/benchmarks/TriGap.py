...
TRIGAP_TASKS = [
    ...
    },
    {
        "cur_task": 1,
        "name": "DocVQA",
        "train_data_path": f"{TRIGAP_INSTRUCTION_DIR}/DocVQA/train_converted.json",
    ...
    },
    {
        "cur_task": 2,
        "name": "ChartQA",
        "train_data_path": f"{TRIGAP_INSTRUCTION_DIR}/ChartQA/train_standard_4w.json",
    ...
    },
    {
        "cur_task": 3,
        "name": "IconQA",
        "train_data_path": f"{TRIGAP_INSTRUCTION_DIR}/IconQA/train.json",
    ...
    },
    {
        "cur_task": 4,
        "name": "InfographicVQA",
        "train_data_path": f"{TRIGAP_INSTRUCTION_DIR}/InfographicVQA/infographicsVQA_train_converted.json",
    ...
    },
    {
        "cur_task": 5,
        "name": "ArxivQA",
        "train_data_path": f"{TRIGAP_INSTRUCTION_DIR}/ArxivQA/train_4w.json",
