...
# 基础模型路径
BASE_MODEL_PATH = "/root/autodl-tmp/llava_base/vicuna"

# CLIP模型路径
CLIP_PATH = "/root/autodl-tmp/llava_base/clip"

# MCIT数据集根目录
MCIT_ROOT = "/root/autodl-tmp/MCIT"

# 预训练的mm_projector
PRETRAIN_MM_PROJECTOR = "/root/autodl-tmp/llava_base/llava-v1.5-7b-base/mm_projector.bin"
