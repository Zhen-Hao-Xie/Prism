...
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m llava.eval.model_others \
        ...
        --question-file /data2/mnt2/zhoudw/zh/MCIT/instructions/Instructions_Original/VQAv2/val.json \
...
python -m llava.eval.eval_vqav2 \
    ...
    --annotation-file /data2/mnt2/zhoudw/zh/MCIT/instructions/Instructions_Original/VQAv2/val.json \
