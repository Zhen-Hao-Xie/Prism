...
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m llava.eval.model_others \
        ...
        --question-file /data2/mnt2/zhoudw/zh/MCIT/instructions/Instructions_Original/TextVQA/test.json \
...
python -m llava.eval.eval_textvqa \
    --annotation-file /data2/mnt2/zhoudw/zh/MCIT/instructions/Instructions_Original/TextVQA/valid.json \
