...
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m llava.eval.model_others \
        ...
        --question-file /data2/mnt2/zhoudw/zh/MCIT/instructions/Instructions_Original/VizWiz/val.json \
...
python -m llava.eval.eval_vizwiz \
    ...
    --annotation-file /data2/mnt2/zhoudw/zh/MCIT/instructions/Instructions_Original/VizWiz/val.json \
